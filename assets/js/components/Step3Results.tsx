      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl shadow-lg p-6 text-center text-white md:col-span-2 h-64 flex flex-col justify-center">
            <h3 className="text-sm font-medium mb-4">전체 금융 건강도</h3>
            <div className="flex-1 flex items-center justify-center">
              <CircularProgress percentage={82} color="#ffffff" size={140} />
            </div>
            <div className="mt-4">
              <p className="text-2xl font-bold">82/100</p>
              <p className="text-sm opacity-90">매우 우수한 상태</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">개인화된 추천사항</h3>
          <p className="text-sm text-gray-600 mb-6">분석 결과를 바탕으로 한 주요 개선 영역입니다</p>
          ...
          {analysisResult?.recommendations ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">고정비 절감</h4>
                <p className="text-sm text-gray-600 mb-3">고정 구독료와 정기 결제를 최적화하여 월 20만원을 절약할 수 있습니다.</p>
                <div className="text-xs">
                  <span className="text-blue-600 font-medium">예상 절약액: 월 20만원</span>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">신용카드 혜택 최적화</h4>
                <p className="text-sm text-gray-600 mb-3">신용카드 혜택과 캐시백 프로그램을 최적화하면 점수를 12점 개선할 수 있습니다.</p>
                <div className="text-xs">
                  <span className="text-green-600 font-medium">점수 개선: +12점</span>
                </div>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-4">
                ...
                <h4 className="font-semibold text-gray-900 mb-2">자동 투자 시작</h4>
                <p className="text-sm text-gray-600 mb-3">월 자동 투자를 설정하면 장기 자산을 35% 늘릴 수 있습니다.</p>
                <div className="text-xs">
                  <span className="text-purple-600 font-medium">장기 성장: +35%</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 text-center max-w-md">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">시간이 더 필요하신가요?</h3>
            <p className="text-sm text-gray-600 mb-4">
              천천히 결과를 리뷰해 보세요. 언제든 다시 돌아와서 더 살펴보실 수 있습니다.
            </p>
            <Link
              href="/"
